...
st.set_page_config(page_title="Cybersécurité - Pratique", page_icon="🔒", layout="wide")
...
with st.container(border=True):
    ...
    with col_image:
        ...
        try:
            ...
            st.error(
                "❌ Impossible de charger l'image. Vérifie que le fichier 'assets/images/cyber.jpeg' existe."
            )

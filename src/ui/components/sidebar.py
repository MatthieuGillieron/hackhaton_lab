...
def setup_sidebar():
    ...
    # Menu de navigation
    st.sidebar.page_link("pages/1_🤖_chatbot.py", label="Chatbot", use_container_width=True)
    st.sidebar.page_link("pages/2_🎯_pratique.py", label="Pratique", use_container_width=True)
